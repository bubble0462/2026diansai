...
{
    {0x4E09, 0xC8, 0xFD}, {0x4E0A, 0xC9, 0xCF}, {0x4E0B, 0xCF, 0xC2},
    {0x4EA4, 0xBD, 0xBB}, {0x4EEA, 0xD2, 0xC7}, {0x4F0F, 0xB7, 0xFC},
    {0x4F4D, 0xCE, 0xBB}, {0x4F4E, 0xB5, 0xCD}, {0x4FDD, 0xB1, 0xA3},
    {0x4FE1, 0xD0, 0xC5}, {0x503C, 0xD6, 0xB5}, {0x504F, 0xC6, 0xAB},
    {0x5146, 0xD5, 0xD7}, {0x5165, 0xC8, 0xEB}, {0x5179, 0xD7, 0xC8},
    {0x51B2, 0xB3, 0xE5}, {0x51C6, 0xD7, 0xBC}, {0x51CF, 0xBC, 0xF5},
    {0x51FA, 0xB3, 0xF6}, {0x529F, 0xB9, 0xA6}, {0x52A8, 0xB6, 0xAF},
    {0x5343, 0xC7, 0xA7}, {0x5347, 0xC9, 0xFD}, {0x5355, 0xB5, 0xA5},
    {0x5360, 0xD5, 0xBC}, {0x538B, 0xD1, 0xB9}, {0x53D1, 0xB7, 0xA2},
    {0x53F7, 0xBA, 0xC5}, {0x5468, 0xD6, 0xDC}, {0x5668, 0xC6, 0xF7},
    {0x566A, 0xD4, 0xEB}, {0x56E0, 0xD2, 0xF2}, {0x5747, 0xBE, 0xF9},
    {0x57FA, 0xBB, 0xF9}, {0x589E, 0xD4, 0xF6}, {0x58F0, 0xC9, 0xF9},
    {0x5927, 0xB4, 0xF3}, {0x59C6, 0xC4, 0xB7}, {0x5B58, 0xB4, 0xE6},
    {0x5B89, 0xB0, 0xB2}, {0x5BBD, 0xBF, 0xED}, {0x5C0F, 0xD0, 0xA1},
    {0x5C4F, 0xC6, 0xC1}, {0x5CF0, 0xB7, 0xE5}, {0x5E26, 0xB4, 0xF8},
    {0x5E45, 0xB7, 0xF9}, {0x5E55, 0xC4, 0xBB}, {0x5E73, 0xC6, 0xBD},
    {0x5EA6, 0xB6, 0xC8}, {0x5FAE, 0xCE, 0xA2}, {0x5F26, 0xCF, 0xD2},
    {0x5F62, 0xD0, 0xCE}, {0x611F, 0xB8, 0xD0}, {0x6548, 0xD0, 0xA7},
    {0x6570, 0xCA, 0xFD}, {0x65B9, 0xB7, 0xBD}, {0x65E0, 0xCE, 0xDE},
    {0x65F6, 0xCA, 0xB1}, {0x663E, 0xCF, 0xD4}, {0x6700, 0xD7, 0xEE},
    {0x6709, 0xD3, 0xD0}, {0x671F, 0xC6, 0xDA}, {0x6837, 0xD1, 0xF9},
    {0x6839, 0xB8, 0xF9}, {0x6863, 0xB5, 0xB5}, {0x68AF, 0xCC, 0xDD},
    {0x6B27, 0xC5, 0xB7}, {0x6B63, 0xD5, 0xFD}, {0x6BD4, 0xB1, 0xC8},
    {0x6BEB, 0xBA, 0xC1}, {0x6CBF, 0xD1, 0xD8}, {0x6D41, 0xC1, 0xF7},
    {0x6D4B, 0xB2, 0xE2}, {0x6E29, 0xCE, 0xC2}, {0x6CE2, 0xB2, 0xA8},
    {0x70B9, 0xB5, 0xE3}, {0x7387, 0xC2, 0xCA}, {0x74E6, 0xCD, 0xDF},
    {0x7535, 0xB5, 0xE7}, {0x76AE, 0xC6, 0xA4}, {0x76CA, 0xD2, 0xE6},
    {0x76F4, 0xD6, 0xB1}, {0x76F8, 0xCF, 0xE0}, {0x77E9, 0xBE, 0xD8},
    {0x793A, 0xCA, 0xBE}, {0x79D2, 0xC3, 0xEB}, {0x7A0B, 0xB3, 0xCC},
    {0x7A33, 0xCE, 0xC8}, {0x7A7A, 0xBF, 0xD5}, {0x7C7B, 0xC0, 0xE0},
    {0x7CBE, 0xBE, 0xAB}, {0x7EB3, 0xC4, 0xC9}, {0x7F6E, 0xD6, 0xC3},
    {0x80FD, 0xC4, 0xDC}, {0x8109, 0xC2, 0xF6}, {0x81EA, 0xD7, 0xD4},
    {0x8868, 0xB1, 0xED}, {0x8870, 0xCB, 0xA5}, {0x89C6, 0xCA, 0xD3},
    {0x89D2, 0xBD, 0xC7}, {0x89E6, 0xB4, 0xA5}, {0x8BA1, 0xBC, 0xC6},
    {0x8BBE, 0xC9, 0xE8}, {0x8BD5, 0xCA, 0xD4}, {0x8BEF, 0xCE, 0xF3},
    {0x8C10, 0xD0, 0xB3}, {0x8C31, 0xC6, 0xD7}, {0x8D6B, 0xBA, 0xD5},
    {0x8DC3, 0xD4, 0xBE}, {0x8F93, 0xCA, 0xE4}, {0x901A, 0xCD, 0xA8},
    {0x9053, 0xB5, 0xC0}, {0x91C7, 0xB2, 0xC9}, {0x91CF, 0xC1, 0xBF},
    {0x952F, 0xBE, 0xE2}, {0x9636, 0xBD, 0xD7}, {0x963B, 0xD7, 0xE8},
    {0x964D, 0xBD, 0xB5}, {0x9891, 0xC6, 0xB5}, {0x989D, 0xB6, 0xEE},
    {0x9AD8, 0xB8, 0xDF}, {0x9F7F, 0xB3, 0xDD}, {0xFF08, 0xA3, 0xA8},
    {0xFF09, 0xA3, 0xA9}, {0xFF0C, 0xA3, 0xAC}, {0xFF1A, 0xA3, 0xBA}
};
